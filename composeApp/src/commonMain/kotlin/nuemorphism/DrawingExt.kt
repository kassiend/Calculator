...
import kz.startmobile.calculator.setMaskFilterRadius
import kz.startmobile.calculator.setStrokeMode
import nuemorphism.shape.CornerShape
import nuemorphism.shape.NeuShape
import nuemorphism.shape.Oval
    ...
    drawIntoCanvas { canvas ->
        ...
        val paint = Paint().also { p ->
            p.asFrameworkPaint().also { nativePaint ->
                ...
                nativePaint.setMaskFilterRadius(blurRadius)
            }
        }
